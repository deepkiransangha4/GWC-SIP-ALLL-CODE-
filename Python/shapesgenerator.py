...
def square_maker(color):
	for i in range(4):
		pencolor(color) #we added color
		forward(side_length)
		right(90)
...
def square_maker(color, side_length):
	for i in range(4):
		pendown()
		pencolor(color) 
		forward(side_length), 
...
square_maker('blue', 50)

penup()
forward(60)

square_maker('green', 50)


def triangle_maker(color, side_length):
	for i in range(3) :
		pendown()
		pencolor(color)
		forward(side_length)
...
triangle_maker('red', 50)

penup()
forward(60)

triangle_maker('blue', 50)

penup()
forward(60)

triangle_maker('green', 50)



def polygon_maker(num_sides, side_length, color):
